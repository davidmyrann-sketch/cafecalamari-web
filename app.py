...
T = {
    "no": {
        ...
        "why_2_p":       "Vi rister ukentlig. Ingen kaffe hos oss er eldre enn 2 uker.",
        ...
        "newsletter_h2":  "Aldri gå tom for god kaffe",
        "newsletter_sub": "Meld deg på og få 10% på første ordre + tips om nye partier rett i innboksen.",
        "newsletter_ph":  "Din e-postadresse",
        "newsletter_btn": "Få 10% rabatt →",
    ...
    "es": {
        ...
        "why_2_p":       "Tostamos cada semana. Ningún café nuestro tiene más de 2 semanas.",
        ...
        "newsletter_h2":  "Nunca te quedes sin buen café",
        "newsletter_sub": "Suscríbete y recibe 10% en tu primer pedido + novedades de nuevos lotes.",
        "newsletter_ph":  "Tu correo electrónico",
        "newsletter_btn": "Obtener 10% descuento →",
    ...
    "en": {
        ...
        "why_2_h":       "Fresh roast",
        "why_2_p":       "We roast weekly. No coffee of ours is older than 2 weeks.",
        ...
        "newsletter_h2":  "Never run out of great coffee",
        "newsletter_sub": "Sign up and get 10% off your first order + news about new batches straight to your inbox.",
        "newsletter_ph":  "Your email address",
        "newsletter_btn": "Get 10% off →",
